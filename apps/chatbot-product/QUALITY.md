...
- [x] `BRAND.md` preenchido em TODAS as seções (cores, tipografia, tom de voz, anti-padrões)
- [x] `BRIEFING.md` com 3+ referências analisadas (o que funciona, o que evitar, aplicação)
- [x] `design-tokens.json` preenchido com a paleta real do app
- [x] Modo 1 (DISCOVERY) executado com 2-3 direções aprovadas
- [x] Modo 2 (PLAN) executado com wireframe seção por seção aprovado
